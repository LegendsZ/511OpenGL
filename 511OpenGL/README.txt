...
Open .sln file via Visual Studio (The version used was 2022 but 2017 should work too)

Build the project in Visual Studio and in 
x64\Debug
the 511OpenGL.exe application can be found, make sure freeglut.dll is included in the same directory.
